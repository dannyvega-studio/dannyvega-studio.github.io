                    ...
                    <Zoom>
                        <Card.Body>
                            <Card.Title>Agile Scrum Essentials</Card.Title>
                                <Card.Text>
                                    <a href="https://techedge.techcanvass.co/Certificate/MTgxMTQtNDc=/Daniel%20EduardoVega%20Ibarra" target="_blank">Credential 508585</a>
                                </Card.Text>
                        </Card.Body>
                        <Card.Img />
                    </Zoom>
                    ...
                    <Zoom>
                        <Card.Body>
                            <Card.Title>Agile Manual and Automation Testing</Card.Title>
                                <Card.Text>
                                    <a href="https://techedge.techcanvass.co/Certificate/MTgxMTQtODE=/Daniel%20EduardoVega%20Ibarra" target="_blank">Credential 592356</a>
                                </Card.Text>
                        </Card.Body>
                        <Card.Img />
                    </Zoom>
